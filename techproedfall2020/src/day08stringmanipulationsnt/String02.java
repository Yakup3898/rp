...
public class String02 {
	...
	public static void main(String[] args) {
		...
		/* Ask user to enter password, if the password is okay for the following conditions output will
		 be "Your password is created successfully."
		...
		String pwd = scan.nextLine();
		 ...
		 if ((pwd.charAt(0) >= 'A' && pwd.charAt(0) <= 'Z') && 
				 (pwd.charAt(pwd.length()-1) >= 'a' && pwd.charAt(pwd.length()-1) <= 'z') && (pwd.length() > 5)) {

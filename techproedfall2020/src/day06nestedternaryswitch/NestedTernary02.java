...
public class NestedTernary02 {
	...
	public static void main(String[] args) {
		...
		String result = pwd.length()==8 && pwd.charAt(0)>='0' && pwd.charAt(0)<='9' ? "The password is valid." : pwd.charAt(pwd.length()-1)=='Z' ? "Not secure but acceptable" : "The password is not valid";

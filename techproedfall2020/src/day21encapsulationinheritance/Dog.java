...
public class Dog extends Mammal {
	...
	/*
	 ...
	 b) Less coding: If you do not put common features in parent class, you should put it into 
	                 every child class one by one. It needs to type same code again and again. that's not good.
	 ...
	 because multiple inheritance creates problem and confusion for Java when the parent classes have the methods whose names are same. 
	 Java cannot be sure which same method it will use.     
